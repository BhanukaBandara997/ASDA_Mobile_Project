...
$fileName = $jsonrec->TopSelectionList->FileName;

unset($jsonrec->TopSelectionList->FileName);
...
if (!is_dir('../models/ProductTypesLists/')) {
mkdir('../models/ProductTypesLists/');
}

//define the file
$jsonFile = "../models/ProductTypesLists/" . $fileName . ".json";
